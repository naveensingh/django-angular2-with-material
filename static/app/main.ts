...
import {ArtistsService} from "./js/movies/services/app.artists.service";
import {GenresService} from "./js/movies/services/app.genres.service";
...
@NgModule({
    ...
    providers: [MoviesService, ArtistsService, GenresService]
})
